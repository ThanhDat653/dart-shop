            ...
            <div className="fixed inset-0 z-[50] flex">
               ...
               >
                  <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                     ...
                     {/* Filters */}
                     <form className="mt-4  border-gray-200 bg-white">
                        {filterData.map((section) => (
                           <Disclosure
                              as="div"
                              key={section.id}
                              className="border-t border-gray-200 px-7 py-6"
                           >
                              {({ open }) => (
                                 <>
                     ...
                     <button
                        onClick={handleCloseSideMenu}
                        className="absolute bottom-0 left-0 right-0 bg-blue-700 hover:bg-blue-600 mx-5 mb-6 py-3 px-24 rounded text-white transition-colors"
                     >
                        Clear All
                     </button>
                  </Dialog.Panel>
